...
OVENS=[
 ...
 ("O3","Bosch HBA574BS3 · Serie 4 · נירוסטה · פירוליטי",2890,
  "https://www.bettershop.co.il/product/bosch-hba574bs3/",
  "https://ecdn.speedsize.com/566103a2-53f1-4a19-905b-45d84f5c6ca2/www.bettershop.co.il/wp-content/uploads/2026/06/HBA574BS3_Product-Image-Standard_4000x4000px_1-squared.jpg",
  ["🥉 מקום 3","האמין"],
  "🥉 מקום 3 — בחירת האמינות: אותה איכות בנייה גרמנית עם כפתורים פשוטים — פחות אלקטרוניקה שיכולה להתקלקל\n⭐ פיצ'ר מיוחד: ניקוי פירוליטי 480° במחיר הזול ביותר בשוק לפיצ'ר הזה\n😊 שביעות רצון: קונצנזוס בפורומים שסדרת הפירוליטי של בוש בנויה חזק יותר; ה-Serie 4 חומק מתלונות פאנל-המגע של הסדרות הגבוהות\n💡 ממשק: כפתורים נשלפים + תצוגת LED — אפס עקומת למידה · תואם מיקרוגל נירוסטה Serie 4"),
]
for o in OVENS:
...
function rebuild(){
  ...
  st.custom.items.forEach(i=>{if(i&&i.id)im[i.id]={...(im[i.id]||{}),...i};});
  Object.values(shared.items||{}).forEach(i=>{if(i&&i.id)im[i.id]={...(im[i.id]||{}),...i};});
